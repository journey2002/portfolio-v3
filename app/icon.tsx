...
// Favicon — the planet mark from Nav.tsx's PlanetLogo, recolored to a fixed
// emerald gradient (the default accent) since a static icon can't read the
// live --accent-glow-* CSS vars. Transparent background so only the mark
// shows, not a filled square tile.
